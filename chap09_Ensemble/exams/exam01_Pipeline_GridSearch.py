...
from sklearn.preprocessing import StandardScaler  # dataset scaling (Z 공식)
...
pipe_svc = Pipeline([('scaler', StandardScaler()), ('svc', SVC(gamma='auto'))])
...
print(model.best_params_)  # {'svc__C': 10.0, 'svc__gamma': 0.01, 'svc__kernel': 'rbf'}
